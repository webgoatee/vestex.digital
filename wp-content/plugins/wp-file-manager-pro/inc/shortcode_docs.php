...
<h1><?php _e('File Manager - Shortcode','wp-file-manager-pro'); ?></h1>
...
<p><strong>USE: <code>[wp_file_manager view="list" lang="en" theme="light" dateformat="d M, Y h:i A" allowed_roles="editor,author" access_folder="wp-content/plugins" write = "true" read = "false" hide_files = "kumar,abc.php" lock_extensions=".php,.css" allowed_operations="upload,download" ban_user_ids="2,3"]</code></strong>
...
<p><strong>(9) view="list"</strong> -> Filemanager UI View. Default: grid</p>
<p><strong>(10) dateformat="d M, Y h:i A" </strong> -> File Modified or Create date format. Default: d M, Y h:i A</p>
<p><strong>(11) lang="en" </strong> -> File manager Language. Default: English(en)</p>
<p><strong>(12) theme="light" </strong> -> File Manager Theme. Default: Light</p>
</div>