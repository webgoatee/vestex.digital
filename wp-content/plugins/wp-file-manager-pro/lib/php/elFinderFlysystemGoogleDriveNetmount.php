        ...
        try {
            ...
            if ($options['user'] === 'init') {
                ...
                $callback  = $options['url']
                           . '?action=mk_file_folder_manager&cmd=netmount&protocol=googledrive&host=1';
                ...
                if (! $aToken && empty($_GET['code'])) {
                    ...
                    $html .= '<script>
                        jQuery("#'.$options['id'].'").elfinder("instance").trigger("netmount", {protocol: "googledrive", mode: "makebtn"});
                    </script>';
