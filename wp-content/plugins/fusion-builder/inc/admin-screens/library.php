...
<div class="wrap about-wrap fusion-builder-wrap">
	...
	<div class="fusion-builder-important-notice">
		<p class="about-description">
			<?php printf( esc_html__( 'This is your collection of Fusion Builder Library Containers, Columns and Elements that you have saved. You can edit them individually below, delete them and sort them per category type. To find out more about the %1$s, view our Fusion Builder documentation.', 'fusion-builder' ), '<a href="https://theme-fusion.com/documentation/fusion-builder/fusion-builder-library/" target="_blank">' . esc_attr__( 'Fusion Builder', 'fusion-builder' ) . '</a>' ); ?>
		</p>
	</div>
