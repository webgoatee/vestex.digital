...
<div class="modal fade" id="wdt-rb-backend-close-modal" data-backdrop="static" data-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <small><?php _e('There is no undo! You will be redirected to Browse reports page.', 'wpdatatables'); ?></small>
                    </div>
                </div>
                <!--/ .row -->
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-danger btn-icon-text waves-effect"
                        id="wdt-rb-backend-close-button"><?php _e('Yes', 'wpdatatables'); ?></button>
            </div>
            <!--/ .modal-footer -->
        </div>
        <!--/ .modal-content -->
